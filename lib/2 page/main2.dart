...
import 'package:jihc/1%20page/Tarihibir.dart';
...
import 'JIHC MENU2.dart';

class TablePage2 extends StatefulWidget {
  final String dbName;

  const TablePage2({Key key, this.dbName}) : super(key: key);
                      ...
                      children: [
                        TextButton(
                          ...
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => Tarihbir()),
                            );
                          },
                          child: const Text(
                            'JIHC',
