...
class Jihcmenu3 extends StatefulWidget {
  _Jihcmenu3State createState() => _Jihcmenu3State();
}

class _Jihcmenu3State extends State<Jihcmenu3> {
  @override
