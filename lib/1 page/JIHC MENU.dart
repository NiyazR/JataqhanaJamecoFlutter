...
import 'BUHGALTERYA/buhgalterya.dart';
import 'NotFoundPage.dart';
import 'Tarihibir.dart';

class Jihcmenu extends StatefulWidget {
  _JihcmenuState createState() => _JihcmenuState();
}

class _JihcmenuState extends State<Jihcmenu> {
  @override
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    image: DecorationImage(
                                      ...
                                      colorFilter: ColorFilter.mode(
                                          ...
                                          BlendMode.srcOver),
                                      image: AssetImage('images/ashana.jpg'),
                                    ),
                                  ),
                                  child: Container(
                                      height:
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    image: DecorationImage(
                                      ...
                                      colorFilter: ColorFilter.mode(
                                          ...
                                          BlendMode.srcOver),
                                      image: AssetImage('images/hobby.jpg'),
                                    ),
                                  ),
                                  child: Container(
                                      height:
            ...
            children: [
              GestureDetector(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => Kezekwilik()),
                  );
                },
              ),
              GestureDetector(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    image: DecorationImage(
                                      ...
                                      colorFilter: ColorFilter.mode(
                                          Colors.black.withOpacity(0.2),
                                          BlendMode.srcOver),
                                      image: AssetImage('images/shah.jpg'),
                                    ),
                                  ),
                                  child: Container(
                                      height:
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => Buhgaltery1()),
                  );
                },
              ),
            ],
