...
class Tusdb {
  ...
  Tusdb({this.Aptakun,this.OkyAky,this.OkyData,this.TamaqData, this.title,this.Aty, this.Uakit, this.Asbir,this.Aseki,this.Astort,this.Asuw,this.Buhgbasnum});

  Tusdb.fromSnapshot(DataSnapshot snapshot)
